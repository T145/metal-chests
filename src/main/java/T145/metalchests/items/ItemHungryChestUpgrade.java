...
public class ItemHungryChestUpgrade extends ItemChestUpgrade {
	...
	public EnumActionResult onItemUseFirst(EntityPlayer player, World world, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ, EnumHand hand) {
		...
		if (te instanceof TileHungryMetalChest && ((TileHungryMetalChest) te).getChestType() == upgrade.getBase()) {
		...
		} else if (te instanceof TileSortingHungryMetalChest && ((TileSortingHungryMetalChest) te).getChestType() == upgrade.getBase()) {
