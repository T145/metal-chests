...
public class RenderMinecartMetalChest extends Render<EntityMinecartMetalChest> {
	...
	@Override
	public void doRender(EntityMinecartMetalChest cart, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		RenderMetalChest.INSTANCE.render(cart.getMetalChest(), 0, 0, 0, 0, -1, 1);
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityMinecartMetalChest entity) {
